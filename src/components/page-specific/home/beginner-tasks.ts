    ...
    return html`
      ...
      <section>
        ...
        <sl-card>
          <h3>Get UPD🪁</h3>
          <p>
            UPD is the Updraft token and it’s used in a lot of places. You’ll
            need at least 5 UPD to complete the rest of the tasks. Swap some ETH
            for UPD.
          </p>
        ...
        <sl-card>
          ...
          <p>
            You can earn UPD by supporting a popular idea. The more you deposit,
            the more you stand to earn. Find an Idea and support it with UPD.
          </p>
        ...
        <sl-card>
          ...
          <p>
            ...
            the world. Fund a Solution you love and earn a reward if others feel
            the same way.
          </p>
