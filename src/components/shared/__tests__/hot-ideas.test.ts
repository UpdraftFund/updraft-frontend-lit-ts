...
describe('HotIdeas Component', () => {
  ...
  let mockIdeas = [
    { id: '1', title: 'Test Idea 1', shares: '100', tags: ['tag1', 'tag2'], creator: { id: '0x123' }, startTime: '123456789', funderReward: '10' },
    { id: '2', title: 'Test Idea 2', shares: '50', tags: ['tag3'], creator: { id: '0x456' }, startTime: '123456789', funderReward: '20' }
  ];
