...
This directory contains tests for discover page components and functionality.
...
import '../discover-component.js';

describe('DiscoverComponent', () => {
  it('renders correctly', async () => {
    const el = await fixture(html`<discover-component></discover-component>`);
